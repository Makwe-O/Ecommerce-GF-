    ...
    return ( 
      <>
        <nav className="navbar navbar-light bg-light">
           <a className="navbar-brand" href="#home">Ecommerce</a>
               <ul className="">
                   <li><a class="btn btn-secondary" href="#singup" target="_blank" rel="noopener noreferrer">Sign Up</a></li>
                   <li><a class="btn btn-secondary" href="#signin" target="_blank" rel="noopener noreferrer">Sign In</a></li>
               </ul>
        ...
        <div className="navbar landing-page"> 
            <animated.div style={props2}>
                <div class="jumbotron lead-text">
                        <h1 class="display-4">Welcome to <strong><span style={{color:`#ffc107`}}>Hat Attack</span></strong></h1>
                        <p class="lead">We have got the best deals for the best quality hats, sneakers and other accessories. <br />Check out what we offer</p>
                        <hr class="my-4" />
            ...
            <div className="row">
                <div className="col col-xs-12 col-lg-4">
                    ...
                    <div className="card-body home-card-body">
                        ...
                        <a href="#home" class="btn btn-secondary">Shop Here</a>
                    </div>
                    </div>
                </div>
